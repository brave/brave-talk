import { parseEIP4361Message, createEIP4361Message } from "./EIP4361";
...
it("Should parse an EIP4361 message correctly", () => {
  const now = new Date().toISOString();
  const requestId = "1";
  const message = `talk.brave.com wants you to sign in with your Ethereum account:
0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
...
- https://example.com/my-web2-claim.json`;
  ...
  const actual = parseEIP4361Message(message);
